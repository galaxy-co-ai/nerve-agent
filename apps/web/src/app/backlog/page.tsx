...
const modules: Module[] = [
  ...
  // Phase 2 - Intelligence
  {
    ...
    dependencies: ["projects"],
    tasks: [
      { id: "ci-1", title: "Build transcript upload UI", status: "done", notes: "/calls/new with form" },
      { id: "ci-2", title: "Integrate Claude API for processing", status: "done", notes: "/api/ai/process-call" },
      { id: "ci-3", title: "Create CallBrief model and storage", status: "done", notes: "Call model in Prisma" },
      { id: "ci-4", title: "Build brief review/edit UI", status: "done", notes: "/calls/[id] detail page" },
      { id: "ci-5", title: "Extract and store Decisions", status: "done", notes: "JSON field on Call" },
      { id: "ci-6", title: "Extract and store Action Items", status: "done", notes: "JSON field on Call" },
      { id: "ci-7", title: "Build follow-up scheduling system", status: "done", notes: "FollowUp model + /dashboard/follow-ups" },
      { id: "ci-8", title: "Create shareable brief view", status: "done", notes: "briefShared + briefToken" },
      { id: "ci-9", title: "Build knowledge search across calls", status: "done", notes: "/api/ai/search-calls" },
    ],
  },
  {
    id: "notes",
    ...
    tasks: [
      ...
      { id: "notes-4", title: "Integrate Claude for AI writing assist", status: "done", notes: "/api/ai/writing endpoint" },
      { id: "notes-5", title: "Build auto-tagging system", status: "done", notes: "AI tag suggestions on quick note" },
      { id: "notes-6", title: "Create note library/browser", status: "done", notes: "/notes with search & filters" },
      { id: "notes-7", title: "Build context graph visualization", status: "done", notes: "React Flow graph on note page" },
  ...
  // Phase 3 - Client-Facing
  {
    ...
    dependencies: ["projects", "sprint-stack"],
    tasks: [
      { id: "cp-1", title: "Create portal route structure", status: "done", notes: "/portal/[token] routes" },
      { id: "cp-2", title: "Build magic link authentication", status: "done", notes: "Email + OTP verification" },
      { id: "cp-3", title: "Create project overview component", status: "done", notes: "Portal dashboard" },
...
const foundationTasks: Task[] = [
  ...
  { id: "f-4", title: "Set up Claude API integration", status: "done", notes: "AI endpoints for calls, writing, search" },
