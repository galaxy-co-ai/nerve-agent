...
const modules: Module[] = [
  // Phase 1 - Core Loop
  {
    ...
    phase: 1,
    tasks: [
      { id: "dd-1", title: "Create daily driver page layout", status: "not-started" },
      { id: "dd-2", title: "Build Today's Focus component", status: "not-started" },
      { id: "dd-3", title: "Build Blockers Cleared component", status: "not-started" },
      { id: "dd-4", title: "Build Client Waiting component", status: "not-started" },
      { id: "dd-5", title: "Build Follow-up Queue component", status: "not-started" },
      { id: "dd-6", title: "Build Time Summary component", status: "not-started" },
      { id: "dd-7", title: "Aggregate data from other modules", status: "not-started" },
    ],
  },
  {
    id: "projects",
    ...
    phase: 1,
    tasks: [
      { id: "proj-1", title: "Set up Prisma schema for Project model", status: "not-started" },
      { id: "proj-2", title: "Create project list page", status: "not-started" },
      { id: "proj-3", title: "Create project detail page", status: "not-started" },
      { id: "proj-4", title: "Build project settings/edit form", status: "not-started" },
      { id: "proj-5", title: "Add project creation flow", status: "not-started" },
    ],
  },
  {
    id: "sprint-stack",
    ...
    tasks: [
      { id: "ss-1", title: "Set up Sprint and Task Prisma models", status: "not-started" },
      { id: "ss-2", title: "Create sprint list view", status: "not-started" },
      { id: "ss-3", title: "Create sprint detail/kanban view", status: "not-started" },
      { id: "ss-4", title: "Build task detail panel", status: "not-started" },
      { id: "ss-5", title: "Implement task status transitions", status: "not-started" },
      { id: "ss-6", title: "Build blocker workflow", status: "not-started" },
      { id: "ss-7", title: "Add time tracking integration hooks", status: "not-started" },
      { id: "ss-8", title: "Build sprint completion flow", status: "not-started" },
    ],
  },
  {
    id: "time-tracking",
    ...
    tasks: [
      { id: "tt-1", title: "Set up Electron project in apps/desktop", status: "not-started" },
      ...
      { id: "tt-6", title: "Build time entry models and storage", status: "not-started" },
      { id: "tt-7", title: "Create daily timeline view in web app", status: "not-started" },
      { id: "tt-8", title: "Build weekly summary view", status: "not-started" },
    ],
  },
  ...
  },
  {
    ...
    phase: 2,
    tasks: [
      { id: "notes-1", title: "Build note editor with markdown support", status: "not-started" },
      { id: "notes-2", title: "Implement wiki-style [[linking]]", status: "not-started" },
      { id: "notes-3", title: "Build backlinks panel", status: "not-started" },
      ...
      { id: "notes-6", title: "Create note library/browser", status: "not-started" },
  ...
  },
  {
    ...
    specFile: "06-vault.md",
    status: "not-started",
    priority: "p1",
    phase: 2,
    tasks: [
      { id: "v-1", title: "Create VaultItem model (blocks, patterns, features, queries)", status: "not-started" },
      { id: "v-2", title: "Build vault browser UI", status: "not-started" },
      { id: "v-3", title: "Create block/pattern detail view", status: "not-started" },
      { id: "v-4", title: "Build 'Add to Vault' flow", status: "not-started" },
      { id: "v-5", title: "Implement copy-to-project functionality", status: "not-started" },
      { id: "v-6", title: "Build search with AI-assisted queries", status: "not-started" },
      { id: "v-7", title: "Track usage analytics", status: "not-started" },
    ],
  },
  ...
  },
  {
    ...
    priority: "p2",
    phase: 4,
    dependencies: ["projects", "sprint-stack", "vault"],
    tasks: [
